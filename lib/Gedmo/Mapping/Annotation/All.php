...
include __DIR__.'/Lucene.php';
include __DIR__.'/LuceneUnStored.php';
include __DIR__.'/LuceneUnIndexed.php';
include __DIR__.'/LuceneText.php';
include __DIR__.'/LuceneBinary.php';
include __DIR__.'/LuceneKeyword.php';
